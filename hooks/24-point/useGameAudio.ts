...
export function useGameAudio(isPlaying: boolean) {
  ...
  const scheduleBgmPhrase = useCallback(() => {
    ...
    melody.forEach((frequency, index) => {
      ...
      gain.gain.linearRampToValueAtTime(0.0055, noteTime + 0.04)
  ...
  const playStart = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.1, frequency: 392, endFrequency: 493.88, volume: 0.03 },
      { offset: 0.1, duration: 0.13, frequency: 523.25, endFrequency: 659.25, volume: 0.034 },
    ])
  }, [playSequence])

  const playNumber = useCallback(() => {
    playSequence([{ offset: 0, duration: 0.08, frequency: 520, endFrequency: 620, volume: 0.024, type: 'triangle' }])
  }, [playSequence])

  const playOperator = useCallback(() => {
    playSequence([{ offset: 0, duration: 0.08, frequency: 410, endFrequency: 470, volume: 0.022, type: 'square', filterFrequency: 2200 }])
  }, [playSequence])

  const playBackspace = useCallback(() => {
    playSequence([{ offset: 0, duration: 0.09, frequency: 360, endFrequency: 250, volume: 0.02 }])
  }, [playSequence])

  const playClear = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.1, frequency: 320, endFrequency: 220, volume: 0.018 },
      { offset: 0.03, duration: 0.12, frequency: 260, endFrequency: 180, volume: 0.016 },
    ])
  }, [playSequence])

  const playHint = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.1, frequency: 587.33, endFrequency: 659.25, volume: 0.022, type: 'sine' },
      { offset: 0.1, duration: 0.14, frequency: 783.99, endFrequency: 987.77, volume: 0.024, type: 'triangle' },
    ])
  }, [playSequence])

  const playSuccess = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.12, frequency: 523.25, endFrequency: 659.25, volume: 0.032, type: 'triangle' },
      { offset: 0.11, duration: 0.12, frequency: 659.25, endFrequency: 783.99, volume: 0.034, type: 'triangle' },
      { offset: 0.22, duration: 0.18, frequency: 783.99, endFrequency: 1046.5, volume: 0.036, type: 'sine' },
    ])
  }, [playSequence])

  const playError = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.13, frequency: 430, endFrequency: 280, volume: 0.026, type: 'sawtooth', filterFrequency: 1800 },
      { offset: 0.08, duration: 0.16, frequency: 260, endFrequency: 190, volume: 0.024, type: 'triangle', filterFrequency: 1400 },
    ])
  }, [playSequence])

  const playSkip = useCallback(() => {
    playSequence([
      { offset: 0, duration: 0.12, frequency: 392, endFrequency: 329.63, volume: 0.02, type: 'triangle' },
      { offset: 0.1, duration: 0.14, frequency: 329.63, endFrequency: 261.63, volume: 0.018, type: 'sine' },
    ])
  }, [playSequence])

  const playTimeout = useCallback(() => {
    playSequenceIfReady([
      { offset: 0, duration: 0.14, frequency: 349.23, endFrequency: 261.63, volume: 0.022, type: 'triangle' },
      { offset: 0.12, duration: 0.18, frequency: 261.63, endFrequency: 196, volume: 0.02, type: 'triangle' },
    ])
  }, [playSequenceIfReady])
