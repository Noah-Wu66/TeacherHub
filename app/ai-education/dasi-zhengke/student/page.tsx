...
export default async function DasiZhengkeStudentPage({ searchParams }: PageProps) {
  ...
  if (isTeacherOrAdmin) {
    ...
    redirect(qs ? `/ai-education/dasi-zhengke/teacher?${qs}` : '/ai-education/dasi-zhengke/teacher');
  }

  return (
    <Suspense>
      <DasiZhengkeClient basePath="/ai-education/dasi-zhengke/student" pageAudience="student" />
    </Suspense>
  );
}
